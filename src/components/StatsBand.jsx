  ...
  return (
    <div ref={ref} className="text-center">
      <div className="text-3xl sm:text-4xl font-heading font-extrabold text-white">
        <i className={`fas ${icon} text-accent mr-2 text-xl`}></i>
        {count}
        {suffix}
      </div>
    ...
    <section className="bg-primary py-14">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <AnimatedCounter end={4000} suffix="+" label="Workers Placed" icon="fa-users" delay={0} />
          <AnimatedCounter end={12} suffix="+" label="Countries" icon="fa-globe" delay={200} />
          <AnimatedCounter end={15} suffix="+" label="Years Experience" icon="fa-calendar" delay={400} />
